...
class Projects extends Component {
  render() {
  let project_object = [
    {id: "aloha", title: "Aloha", site_link: "#", git_link:"https://github.com/jeanmaried/Aloha_shopping_page", description:"Responsive shopping website landing page making use of Sass and Gulp"},
